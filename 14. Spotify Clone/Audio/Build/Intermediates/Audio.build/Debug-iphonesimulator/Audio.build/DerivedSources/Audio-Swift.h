...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Audio",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Audio11AppDelegate")
...
SWIFT_CLASS("_TtC5Audio13SceneDelegate")
...
SWIFT_CLASS("_TtC5Audio14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)playButtonDidTapped:(UIButton * _Nonnull)sender;
- (IBAction)pauseButtonDidTapped:(UIButton * _Nonnull)sender;
