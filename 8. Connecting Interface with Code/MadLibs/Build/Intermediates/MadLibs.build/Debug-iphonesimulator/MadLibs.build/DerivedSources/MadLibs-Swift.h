...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MadLibs",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7MadLibs11AppDelegate")
...
SWIFT_CLASS("_TtC7MadLibs13SceneDelegate")
...
SWIFT_CLASS("_TtC7MadLibs14ViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified verbTextField;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified numberOfPetsLabel;
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified animalSegmentedControl;
@property (nonatomic, weak) IBOutlet UISlider * _Null_unspecified numberSlider;
@property (nonatomic, weak) IBOutlet UIStepper * _Null_unspecified numberOfPetsStepper;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified happyEndingSwitch;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified containerView;
- (IBAction)lessOrMoreValueDidChanged:(UISegmentedControl * _Nonnull)sender;
- (IBAction)sliderDidChanged:(UISlider * _Nonnull)sender;
- (IBAction)stepperDidChange:(UIStepper * _Nonnull)sender;
- (IBAction)createStoryDidTapped:(UIButton * _Nonnull)sender;
