...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RemindersApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12RemindersApp11AppDelegate")
...
SWIFT_CLASS("_TtC12RemindersApp30FavoriteReminderViewController")
@interface FavoriteReminderViewController : UIViewController
...
SWIFT_CLASS("_TtC12RemindersApp25NewReminderViewController")
...
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified completedSwitch;
- (void)viewDidLoad;
- (IBAction)saveButtonDidTapped:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12RemindersApp12ReminderCell")
@interface ReminderCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified isCompletedView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified dateLabel;
...
SWIFT_CLASS("_TtC12RemindersApp23RemindersViewController")
@interface RemindersViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableview;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)editButtonDidPressed:(UIBarButtonItem * _Nonnull)sender;
...
SWIFT_CLASS("_TtC12RemindersApp13SceneDelegate")
