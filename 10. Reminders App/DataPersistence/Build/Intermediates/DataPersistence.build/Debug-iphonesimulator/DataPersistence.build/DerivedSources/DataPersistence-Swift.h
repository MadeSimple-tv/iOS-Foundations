...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DataPersistence",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15DataPersistence11AppDelegate")
...
SWIFT_CLASS("_TtC15DataPersistence13SceneDelegate")
...
SWIFT_CLASS("_TtC15DataPersistence14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified textTextField;
- (void)viewDidLoad;
- (IBAction)saveDidTapped:(UIButton * _Nonnull)sender;
