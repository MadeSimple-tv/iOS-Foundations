...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CollectionVIews",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15CollectionVIews11AppDelegate")
...
SWIFT_CLASS("_TtC15CollectionVIews13SceneDelegate")
...
SWIFT_CLASS("_TtC15CollectionVIews14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(CollectionVIews)) <UICollectionViewDelegate>
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UICollectionViewCell;

@interface ViewController (SWIFT_EXTENSION(CollectionVIews)) <UICollectionViewDataSource>
